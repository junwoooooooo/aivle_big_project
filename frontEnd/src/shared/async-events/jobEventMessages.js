const messages = {
  ...
  'job.concept.run.queued': 'Concept 탐색 작업을 준비하고 있습니다.',
  'job.concept.run.started': 'Concept Factory 실행을 시작했습니다.',
  ...
  'job.concept.run.needs_input': 'Concept 생성을 위해 확인할 정보가 남아 있습니다.',
