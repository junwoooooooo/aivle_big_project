const messages = Object.freeze({
  ...
  'job.final-report.queued': '사업기획서 작성을 준비하고 있습니다.',
  'job.final-report.composing': '선택한 분석 자료로 사업기획서를 구성하고 있습니다.',
  'job.final-report.completed': '사업기획서가 준비되었습니다.',
  'job.final-report.failed': '사업기획서를 완료하지 못했습니다.',
  'job.final-report.review.queued': '사업기획서 검토를 준비하고 있습니다.',
  'job.final-report.review.running': '사업 논리와 의사결정 준비도를 검토하고 있습니다.',
  'job.final-report.review.completed': 'AI 사업기획서 검토가 완료되었습니다.',
  'job.final-report.review.failed': 'AI 사업기획서 검토를 완료하지 못했습니다.',
  ...
  'job.market-interview.queued': '시장 인터뷰를 준비하고 있습니다.',
  'job.market-interview.running': '가상 고객 관점에서 사업안을 검토하고 있습니다.',
  'job.market-interview.completed': '시장 인터뷰 결과가 준비되었습니다.',
  'job.market-interview.failed': '시장 인터뷰를 완료하지 못했습니다.',
