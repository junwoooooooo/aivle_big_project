...
describe('marketing setup model', () => {
  it('maps CTA and phrase fields into the closed R6A request contract', () => {
    const setup = { ...createSetupModel('planning-1'), channel: 'Instagram', purpose: 'launch',
    ...
    expect(request).toEqual(expect.objectContaining({ contract: 'marketing-content-request-v1', planningSnapshotId: 'planning-1', contentType: 'SOCIAL_POST' }));
