...
export default function WorkflowSection({ onNavigate }) {
  ...
  return <section id="workflow" className="landing-section landing-workflow" aria-labelledby="workflow-title"><div className="landing-container"><p className="landing-eyebrow">HOW IT WORKS</p><h2 id="workflow-title">하나의 아이디어가,<br />하나의 검증 여정이 됩니다.</h2><p className="landing-section__lede">현황 점검부터 결과 보고서까지, 저장된 결과와 사용자 선택을 따라 8단계로 진행합니다.</p><div ref={desktopRef} className="workflow-desktop" tabIndex="0" onKeyDown={onKeyDown} aria-label="8단계 사업 검증 흐름">
