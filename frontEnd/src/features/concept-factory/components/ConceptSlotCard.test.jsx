...
describe('ConceptSlotCard', () => {
  it('shows safe progress without exposing draft concept detail', () => {
    render(<ConceptSlotCard slot={{ slotNumber: 1, variationFocus: 'CUSTOMER_EXPERIENCE', status: 'VALIDATING_LEGAL', currentAttemptPhase: 'INITIAL', attemptCount: 2, updatedAt: '2026-08-06T12:00:00Z' }} />);
  ...
  it('shows only readiness copy for an eligible slot before global reveal', () => {
    render(<ConceptSlotCard slot={{ slotNumber: 5, variationFocus: 'LOW_RISK_FAST_EXECUTION', status: 'ELIGIBLE', currentAttemptPhase: 'REPLACEMENT', attemptCount: 3 }} />);
