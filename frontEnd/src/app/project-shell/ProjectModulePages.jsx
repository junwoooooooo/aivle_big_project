...
const MODULE_DESCRIPTIONS = Object.freeze({
  ...
  market: '선택한 컨셉을 외부 시장분석 모듈에 전달하고 연결 상태를 확인합니다.',
  businessPersonaTest: '확정된 기획을 BM·재무 및 페르소나 외부 모듈에 전달합니다.',
  marketing: '확정된 기획으로 마케팅 콘텐츠를 제작합니다.',
});
...
export function ProjectOverviewPage() {
  ...
  return <section className="pipeline-overview" aria-labelledby="project-overview-title">
    <div className="pipeline-page-heading"><p>6단계 파이프라인</p><h2 id="project-overview-title">프로젝트 개요</h2><span>각 모듈은 독립 상태로 표시되며 상태와 관계없이 언제든 화면을 열 수 있습니다.</span></div>
