...
const JOURNEY_DESCRIPTIONS = Object.freeze({
  diagnosis: '현재 아이디어와 준비 상태를 확인해 출발점을 정리합니다.',
  ...
  twinSurvey: 'AI 가상 패널의 정량 시뮬레이션으로 사업안을 비교합니다.',
...
export function ProjectOverviewPage() {
  ...
  return <section className="pipeline-overview" aria-labelledby="project-overview-title">
    <div className="pipeline-page-heading"><p>8단계 사업 여정</p><h2 id="project-overview-title">프로젝트 개요</h2><span>현재 위치와 다음 할 일을 하나의 흐름에서 확인하세요.</span></div>
