...
const journeys = [
  ...
  ['twinSurvey', '트윈 패널', 'NOT_STARTED'], ['marketingStrategy', '마케팅 전략', 'NOT_STARTED'], ['finalReport', '최종 보고서', 'NOT_STARTED'],
...
describe('project overview journey map', () => {
  it('7개 업무를 카드 격자가 아닌 하나의 여정 지도와 행동형 CTA로 표시한다', () => {
    ...
    expect([...screen.getByRole('list').children].map((node) => node.querySelector('.journey-map__step').textContent)).toEqual(['1단계', '2단계', '3단계', '4단계', '5단계', '6단계', '7단계']);
