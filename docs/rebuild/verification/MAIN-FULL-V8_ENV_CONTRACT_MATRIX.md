...
MINIO_API_PORT|compose.yaml, scripts/docker-e2e-smoke.ps1, scripts/docker-failure-e2e.ps1|INFRA_ONLY|9000|NO|YES|YES|NO|NO|YES|NO
MINIO_BUCKET|scripts/ai-artifact-smoke.ps1|INFRA_ONLY||NO|NO|NO|NO|NO|YES|NO
MINIO_CONSOLE_PORT|scripts/docker-e2e-smoke.ps1, scripts/docker-failure-e2e.ps1|INFRA_ONLY||NO|NO|NO|NO|NO|NO|NO
...
OBJECT_STORAGE_PUBLIC_ENDPOINT|backend/src/main/resources/application.yaml, compose.yaml, scripts/ai-local-smoke.ps1|OPTIONAL_RUNTIME|http://localhost:9000|NO|YES|NO|NO|NO|YES|NO
