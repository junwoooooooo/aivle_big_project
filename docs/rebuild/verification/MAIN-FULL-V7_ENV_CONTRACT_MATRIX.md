...
AI_E2E_FAULTS_ENABLED|compose.yaml, scripts/docker-failure-e2e.ps1|E2E_TEST_ONLY|false|NO|YES|NO|NO|NO|YES|NO
AI_E2E_FAULT_DELAY_SECONDS|compose.yaml|E2E_TEST_ONLY|5|NO|YES|NO|NO|NO|YES|NO
AI_E2E_FAULT_MODE|compose.yaml, scripts/docker-failure-e2e.ps1|E2E_TEST_ONLY||NO|YES|NO|NO|NO|YES|NO
...
AI_SERVER_CONCEPT_PORTFOLIO_READ_TIMEOUT|backend/src/main/resources/application.yaml, compose.yaml|OPTIONAL_RUNTIME|15m|NO|YES|NO|NO|NO|YES|NO
...
AI_SERVER_LONG_READ_TIMEOUT|backend/src/main/resources/application.yaml, compose.yaml|OPTIONAL_RUNTIME|7m|NO|YES|NO|NO|NO|YES|NO
AI_SERVER_MARKET_RESEARCH_READ_TIMEOUT|backend/src/main/resources/application.yaml, compose.yaml|OPTIONAL_RUNTIME|22m|NO|YES|NO|NO|NO|YES|NO
...
AI_SERVER_READ_TIMEOUT|backend/src/main/resources/application.yaml, compose.yaml, scripts/docker-failure-e2e.ps1|OPTIONAL_RUNTIME|30s|NO|YES|NO|NO|NO|YES|NO
...
APP_E2E_DEFER_ARTIFACT_WAKE|compose.yaml, scripts/docker-failure-e2e.ps1|E2E_TEST_ONLY|false|NO|YES|NO|NO|NO|YES|NO
...
CORS_ALLOWED_ORIGINS|backend/src/main/resources/application.yaml, compose.yaml|OPTIONAL_RUNTIME|http://localhost:5173,http://127.0.0.1:5173|NO|YES|YES|NO|NO|YES|NO
...
MINIO_ROOT_PASSWORD|compose.infrastructure.yaml, compose.yaml, scripts/ai-artifact-smoke.ps1|REQUIRED_RUNTIME|replace-with-local-secret|YES|YES|YES|NO|YES|YES|YES
MINIO_ROOT_USER|compose.infrastructure.yaml, compose.yaml, scripts/ai-artifact-smoke.ps1|INFRA_ONLY|aivle-local|NO|YES|YES|NO|YES|YES|NO
...
POSTGRES_PASSWORD|compose.infrastructure.yaml, compose.yaml|REQUIRED_RUNTIME|replace-with-local-secret|YES|YES|YES|NO|YES|YES|YES
...
TWIN_BANK_HOST_DIR|compose.yaml, scripts/check_local_env.py|OPTIONAL_RUNTIME||NO|YES|YES|NO|NO|YES|NO
