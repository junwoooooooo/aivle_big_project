...
| `ABSENT` | `backend/src/main/java/com/aivle/backend/pipeline/marketinterview/MarketInterviewInputFactory.java` / `fc755d8747386451d2d6e8c9e4907b553f530c69` | finalized board/price validation, explicit non-conflicting Spring bean name, then MAIN input factory delegation | WRAPPER_ONLY |
