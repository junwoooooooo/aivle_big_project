...
public class MarketResearchRun extends BaseEntity {
    ...
    @Column(name = "source_market_version_id") private Long sourceMarketVersionId;
    ...
    public static MarketResearchRun create(Project project, Kind kind, MarketResearchRun sourceRun,
        ...
        return create(project, kind, sourceRun, taskRun, inputHash, null, null, null, null, null);
    }

    public static MarketResearchRun create(Project project, Kind kind, MarketResearchRun sourceRun,
            TaskRun taskRun, String inputHash, Long sourceMarketVersionId,
            String sourceMarketSeedSnapshotId, Long sourcePortfolioSelectionId,
        ...
        value.sourceMarketVersionId = sourceMarketVersionId;
        value.sourceMarketSeedSnapshotId = sourceMarketSeedSnapshotId;
        value.sourcePortfolioSelectionId = sourcePortfolioSelectionId;
        value.sourceSelectionRevision = sourceSelectionRevision;
