...
@Entity @Table(name="interview_synthesis_runs") @Getter @NoArgsConstructor(access=AccessLevel.PROTECTED)
public class InterviewSynthesisRun extends BaseEntity {
    ...
    @Column(name="interview_ids_json",nullable=false,columnDefinition="TEXT") private String interviewIdsJson;
    ...
    public static InterviewSynthesisRun pending(Project p,ConceptVersion concept,PersonaStudy study,String interviewIdsJson){InterviewSynthesisRun v=new InterviewSynthesisRun();v.project=p;v.conceptVersion=concept;v.study=study;v.interviewIdsJson=interviewIdsJson;v.state=State.PENDING;return v;}
