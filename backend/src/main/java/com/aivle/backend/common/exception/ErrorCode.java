...
public enum ErrorCode {
    ...
    MARKETING_STRATEGY_SOURCE_INCOMPLETE(HttpStatus.CONFLICT, "현재 확정 사업안을 먼저 준비해 주세요.", false),
    MARKETING_STRATEGY_SOURCE_TOO_LARGE(HttpStatus.PAYLOAD_TOO_LARGE, "마케팅 전략에 사용할 분석 자료의 크기가 너무 큽니다.", false),
