...
public enum ErrorCode {
    ...
    MARKETING_STRATEGY_NOT_FOUND(HttpStatus.NOT_FOUND, "마케팅 전략을 찾을 수 없습니다.", false),
    MARKETING_STRATEGY_SOURCE_INCOMPLETE(HttpStatus.CONFLICT, "시장·BM·기술운영·재무·패널 조사 결과를 모두 완료해 주세요.", false),
    MARKETING_STRATEGY_SOURCE_TOO_LARGE(HttpStatus.PAYLOAD_TOO_LARGE, "마케팅 전략 생성에 사용할 분석 자료의 크기가 너무 큽니다.", false),
